...
{
	m_ProjectionMatrix = glm::ortho(-(width / 2), width / 2, height / 2, -(height / 2), 0.0f, 100.f);
...
{
	m_ViewMatrix = glm::lookAt(glm::vec3(0, 0, -1), {0, 0, 0}, {-1, 0, 0});
...
{
	m_ViewMatrix = glm::translate(m_ViewMatrix, {x, y, 0});
